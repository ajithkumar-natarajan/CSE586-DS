...
//        Log.d(tel.toString(), "tel1");
//        Log.d(tel.getLine1Number(), "tel2");
//        Log.d(tel.getLine1Number().substring(tel.getLine1Number().length() - 4), "tel5");
//        Log.d(("value: "+Integer.parseInt(portStr) * 2), "tel3");
//        Log.d(myPort, "tel4");
